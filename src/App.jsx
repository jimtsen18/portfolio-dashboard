...
const KPICard = ({ label, value, sub, color="#38bdf8" }) => (
  <div style={{ background:"#1a1f2e", border:"1px solid #2a3045", borderRadius:12, padding:"16px 20px", minWidth:0 }}>
            ...
            {filteredSnapshots.length >= 2 ? (
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={filteredSnapshots} margin={{ top:4, right:16, left:0, bottom:0 }}>
                  ...
                  <XAxis dataKey="date" tick={{ fill:"#6b7a99", fontSize:10 }} tickFormatter={v => v.slice(5)} />
